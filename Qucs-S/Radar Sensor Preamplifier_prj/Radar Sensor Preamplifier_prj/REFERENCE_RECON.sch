...
<Properties>
  <View=306,-219,1615,753,0.477429,0,0>
  <Grid=10,10,1>
  <DataSet=REFERENCE_RECON.dat>
  <DataDisplay=REFERENCE_RECON.dpl>
  <OpenDisplay=0>
  <Script=REFERENCE_RECON.m>
  <RunScript=0>
  <showFrame=0>
  <FrameText0=Title>
  <FrameText1=Drawn By:>
...
<Components>
  ...
  <Pac P2 1 980 400 18 -26 0 1 "2" 1 "50 Ohm" 1 "0 dBm" 0 "1 MHz" 0 "26.85" 0 "true" 0>
  ...
  <Eqn Eqn1 1 1480 30 -29 17 0 0 "dB_21=dB(S[2,1])" 1 "dB_11=dB(S[1,1])" 1 "dB_22=dB(S[2,2])" 1 "yes" 0>
</Components>
<Wires>
  ...
  <880 370 980 370 "" 0 0 0 "">
  <820 410 820 500 "" 0 0 0 "">
  <980 430 980 500 "" 0 0 0 "">
  ...
  <820 500 980 500 "" 0 0 0 "">
  <650 400 780 400 "" 0 0 0 "">
  <780 390 780 400 "" 0 0 0 "">
  <840 370 840 380 "" 0 0 0 "">
</Wires>
<Diagrams>
</Diagrams>
<Paintings>
